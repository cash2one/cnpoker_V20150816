#ifndef _YOND_MD5_HPP_INCLUDED_
#define _YOND_MD5_HPP_INCLUDED_
...
public:
	...
	BOOL GetMD5(LPBYTE pData, UINT nLength, LPVOID pMD5)
	{
		//calculate and return the checksum
		CMD5Code	MD5Checksum;

		MD5Checksum.Update(pData, nLength);

		return MD5Checksum.Final((BYTE *) pMD5);
	}
...
private:
	...
	BOOL Final(BYTE * pData)
	{
		...
		DWordToByte(pData, m_lMD5, nMD5Size);

		return true;
	}

	inline ULONG RotateLeft(ULONG x, int n)
	{
		//rotate and return x
		return (x << n) | (x >> (32-n));
	}

	inline void FF(ULONG& A, ULONG B, ULONG C, ULONG D, ULONG X, ULONG S, ULONG T)
	{
		ULONG	F;
	...
	inline void GG(ULONG& A, ULONG B, ULONG C, ULONG D, ULONG X, ULONG S, ULONG T)
	{
		ULONG	G;
	...
	inline void HH(ULONG& A, ULONG B, ULONG C, ULONG D, ULONG X, ULONG S, ULONG T)
	{
		ULONG	H;
	...
	inline void II(ULONG& A, ULONG B, ULONG C, ULONG D, ULONG X, ULONG S, ULONG T)
	{
		ULONG	I;
	...
	//utility functions
	inline void DWordToByte(BYTE * Output, ULONG * Input, UINT nLength)
	{
	...
	inline void ByteToDWord(ULONG * Output, BYTE * Input, UINT nLength)
	{
		//initialisations
